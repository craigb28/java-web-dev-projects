...
public class Case {
    ...
    public Case() {
        ...
        Topping topping1 = new Topping("fudge", 1.25, new ArrayList<>(Arrays.asList("chocolate")));
        Topping topping2 = new Topping("caramel", 0.75, new ArrayList<>(Arrays.asList("sugar")));
        Topping topping3 = new Topping("sprinkles", 0.50, new ArrayList<>(Arrays.asList("sugar")));
